...
export default async function HomePage() {
  ...
  return (
    <div className="page">
      ...
      <section className="fold-text reveal" style={{ "--i": 1 } as React.CSSProperties}>
      ...
      {/* Elsewhere — the two sister sites, as an index rather than cards. */}
      <section className="fold-text fold-text--wide reveal" style={{ "--i": 2 } as React.CSSProperties}>
        <div className="head">
          <h2 className="head__title">Elsewhere</h2>
          <p className="head__sub">Three sites, one practice.</p>
        </div>
